...
public class RazorSyntaxTree
{
        ...
        IEnvironmentProvider environmentProvider)
    {
        ...
        var absolutePath = _environmentProvider.AbsolutePathFactory(resourceUri.Value, false, tokenBuilder: new StringBuilder(), formattedBuilder: new StringBuilder(), AbsolutePathNameKind.NameNoExtension);
        ...
        TextEditorTextSpan textSpan)
    {
        ...
        foreach (var kvp in matchingKvps)
        {
            ...
            if (typeDefinitionNode is not null && typeDefinitionNode.InheritedTypeReference != TypeFacts.NotApplicable.ToTypeReference())
            {
                ...
                var compilerServiceResource = _razorCompilerService.GetResource(stringWalker.ResourceUri);
        ...
        // Syntax highlight the keyword as a razor keyword specifically
        {
            injectedLanguageFragmentSyntaxes.Add(
                new InjectedLanguageFragmentNode(
                    ...
                    new TextEditorTextSpan(
                        stringWalker.PositionIndex,
                        stringWalker.PositionIndex + matchedOn.Length,
                        (byte)HtmlDecorationKind.InjectedLanguageFragment)));
        ...
        string matchedOn)
    {
        ...
        switch (matchedOn)
        {
            ...
            case RazorKeywords.NAMESPACE_KEYWORD:
                {
                    // @namespace Walk.TextEditor.Demo.ServerSide.Pages
                    break;
                }
                ...
                // Syntax highlight the keyword as a razor keyword specifically
                {
                    tagSyntaxes.Add(
                        new InjectedLanguageFragmentNode(
                            ...
                            new TextEditorTextSpan(
                                stringWalker.PositionIndex,
                                stringWalker.PositionIndex + elseIfKeywordCombo.Length,
                                (byte)HtmlDecorationKind.InjectedLanguageFragment)));
                ...
                // Syntax highlight the keyword as a razor keyword specifically
                {
                    tagSyntaxes.Add(
                        new InjectedLanguageFragmentNode(
                            ...
                            new TextEditorTextSpan(
                                stringWalker.PositionIndex,
                                stringWalker.PositionIndex + CSharpRazorKeywords.ELSE_KEYWORD.Length,
                                (byte)HtmlDecorationKind.InjectedLanguageFragment)));
                ...
                // Syntax highlight the keyword as a razor keyword specifically
                {
                    tagSyntaxes.Add(
                        new InjectedLanguageFragmentNode(
                            ...
                            new TextEditorTextSpan(
                                stringWalker.PositionIndex,
                                stringWalker.PositionIndex + CSharpRazorKeywords.WHILE_KEYWORD.Length,
                                (byte)HtmlDecorationKind.InjectedLanguageFragment)));
