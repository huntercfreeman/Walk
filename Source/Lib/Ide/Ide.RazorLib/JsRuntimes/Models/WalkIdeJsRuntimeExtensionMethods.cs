...
/// </remarks>
public static class WalkIdeJsRuntimeExtensionMethods
{
    public static WalkIdeJavaScriptInteropApi GetWalkIdeApi(this IJSRuntime jsRuntime)
    {
        return new WalkIdeJavaScriptInteropApi(jsRuntime);
    }
}
