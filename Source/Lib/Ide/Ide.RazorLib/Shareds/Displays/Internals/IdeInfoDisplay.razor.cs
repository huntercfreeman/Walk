...
//             I'm thinking that when publishing the Walk.Ide.Photino.csproj,
...
//             flag that was used to publish the 'Walk.Ide.Photino.csproj' project itself.
...
// ==========================================================================================================
//
// I ran the 'Walk.Ide.Photino.csproj' various ways while using the
...
// "Walk", and write out if that specific assembly has
// the debug attribute.
// 
