...
public struct Scope
{
	...
	public Scope(
		int indexCodeBlockOwner,
		int indexKey,
		int parentIndexKey,
		int startInclusiveIndex,
		int endExclusiveIndex)
	{
		IndexCodeBlockOwner = indexCodeBlockOwner;
		IndexKey = indexKey;
	...
	/// <summary>
	/// Index where the 'ICodeBlockOwner' exists within 'IExtendedCompilationUnit.CodeBlockOwnerList'.
	/// </summary>
	public int IndexCodeBlockOwner { get; }
	/// <summary>
