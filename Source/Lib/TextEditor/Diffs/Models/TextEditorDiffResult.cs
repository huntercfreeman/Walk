            ...
            while (runningRowIndex != -1 && runningColumnIndex != -1)
            {
                    ...
                    cell.Weight == targetSourceWeight)
                {
                    ...
                    if (cell.BeforeCharValue != cell.AfterCharValue)
                        throw new WalkTextEditorException($"The {nameof(cell.BeforeCharValue)}:'{cell.BeforeCharValue}' was not equal to the {nameof(cell.AfterCharValue)}:'{cell.AfterCharValue}'");
