...
namespace Walk.TextEditor.RazorLib.Exceptions;
...
/// </remarks>
public class WalkTextEditorException : WalkException
{
    public WalkTextEditorException(string? message = null, Exception? innerException = null)
